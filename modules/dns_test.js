function dnsModule(enabledOptions, ajaxUrls, tzOffset) {
	...
	*/
	this.series = function() {
        ...
        var latency = function(value) {
            return getSimpleColour( (value / 80) * 255 );
        };
        ...
        var latencyColorStops = [[0, "#ff0000"], [0.5, "#ffff00"], [1, "#00ff00"]];
        ...
        var boxes = {
			max: {
				...
				yaxis: 1,
                heatmap: {
                    valueToColor: latency,
                    smooth: true,
                    colorStops: latencyColorStops
                }
			},
			min: {
				color: "#9440ED",
